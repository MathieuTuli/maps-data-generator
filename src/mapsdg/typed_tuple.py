...
class TypedTuple:
    ...
    def __new__(cls, *args, **kwargs):
        ...
        # For each positional argument, get the typed attribute, and check
        # it's validity
        new_args = []
        ...
        # For each keyword argument, get the typed attribute, and check
        # it's validity
        new_kwargs = {}
    ...
    def __parse_attribute(cls, typed_attr, attr_value):
        # Try to find a function defined on the class to do checks on the
        # supplied value
